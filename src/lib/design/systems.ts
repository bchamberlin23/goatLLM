...
export const DESIGN_SYSTEMS: DesignSystem[] = [
  ...
  },
  {
    ...
    name: "Notion (Dark)",
    category: "productivity",
    tagline: "Notion's dark mode. Cream-on-charcoal, editorial calm.",
    swatches: ["#191919", "#202020", "#2383e2", "#ffffff"],
    fonts: { display: "Söhne", body: "Söhne", mono: "JetBrains Mono" },
    designMd: ds("Notion (Dark)", {
      voice: "Calm, organized, never corporate. Dark mode done right.",
      palette: "bg #191919 · surface #202020 · border #37352f · fg #ffffffee · mute #ffffff99 · primary #2383e2 (blue) · success #0f7b6c · warning #d9730d · error #e03e3e.",
      typography: "Söhne 28-40px / 500-600 for display. Body Söhne 16px / 400 / 1.5. Mono JetBrains Mono. Tight tracking.",
      spacing: "4-pt baseline. Spacing: 4 / 8 / 12 / 16 / 24px. Document-style 720px content max.",
      components: "Cards with 3px radius. Buttons rounded-sm (3px). Borders 1px solid. Shadows subtle. Blue CTA.",
      motion: "Soft, calm. Transitions 200ms. No bouncy animations. Hover states subtle.",
      brand: "Notion dark mode. Cream-on-charcoal. Hand-drawn illustrations. Toggle blocks. Inline databases.",
  ...
  },
  {
    ...
    category: "ai",
    tagline: "AI search dark mode. Minimal, academic, answer-first.",
    swatches: ["#1a1a1a", "#242424", "#20b8cd", "#f5f5f5"],
    fonts: { display: "Inter", body: "Inter", mono: "JetBrains Mono" },
    designMd: ds("Perplexity (Dark)", {
      voice: "Minimal, trustworthy, answer-first. The interface disappears.",
      palette: "bg #1a1a1a · surface #242424 · border #333333 · fg #f5f5f5 · mute #888888 · primary #20b8cd (teal) · accent #20b8cd.",
      typography: "Inter 28-40px / 500 for display. Body Inter 15-17px / 400 / 1.6. Mono JetBrains Mono. Generous measure.",
      spacing: "4-pt baseline. Spacing: 4 / 8 / 12 / 16 / 24px. Search-first layouts. 720px content max.",
      components: "Cards with 8px radius. Buttons rounded-md (6px). Borders 1px solid. Shadows subtle. Teal CTA.",
      motion: "Almost none. Results appear. No page transitions. No hover lifts.",
      brand: "Perplexity teal. Answer-first. Citation-driven. Minimal chrome. Academic feel.",
      antiPatterns: "No bright colors. No playful animations. No heavy shadows. No rounded-xl. No serif fonts.",
    }),
  },
  {
    ...
    name: "Claude",
    category: "ai",
    tagline: "Anthropic's AI assistant. Warm, careful, trustworthy.",
    swatches: ["#f4f0ec", "#ebe5dd", "#cc785c", "#191919"],
    fonts: { display: "Tiempos Headline", body: "Tiempos Text", mono: "Berkeley Mono" },
    designMd: ds("Claude", {
      voice: "Measured, values-led, careful. Research lab that builds products.",
      palette: "bg #f4f0ec · surface #ebe5dd · border #d5cfc7 · fg #191919 · mute #67635c · primary #cc785c (warm clay) · success #16a34a.",
      typography: "Tiempos Headline 36-64px / 500 for display. Body Tiempos Text 17-18px / 400 / 1.65. Mono Berkeley Mono. Editorial feel.",
      spacing: "8-pt baseline. Spacing: 8 / 16 / 24 / 32 / 48px. Generous editorial measure (~70ch).",
      components: "Cards with 0px radius (sharp). Buttons rounded-sm (2px). Borders 1px solid. Shadows subtle. Clay CTA.",
      motion: "Almost none. The page is an essay. Transitions 200ms. No decorative animations.",
      brand: "Claude clay. Tiempos serif. Asterisk mark. Careful, values-led. Research-first.",
      antiPatterns: "No purple. No gradients. No glow. No rounded-xl. No playful animations. No sans-serif display.",
    }),
  },
  {
    id: "chatgpt",
    name: "ChatGPT",
    category: "ai",
    tagline: "OpenAI's conversational AI. Green, minimal, accessible.",
    swatches: ["#ffffff", "#f7f7f8", "#10a37f", "#202123"],
    fonts: { display: "Söhne", body: "Söhne", mono: "Söhne Mono" },
    designMd: ds("ChatGPT", {
      voice: "Plain, technical, careful. Release notes voice.",
      palette: "bg #ffffff / #202123 (dark) · surface #f7f7f8 / #2a2b32 · border #e5e5e5 / #40414f · fg #202123 / #ececf1 · primary #10a37f (green).",
      typography: "Söhne 28-48px / 500-600 for display. Body Söhne 16-17px / 400 / 1.5. Mono Söhne Mono. Clean, readable.",
      spacing: "4-pt baseline. Spacing: 4 / 8 / 12 / 16 / 24px. Chat-first layouts. Centered hero rare.",
      components: "Cards with 8px radius. Buttons rounded-md (6px). Borders 1px solid. Shadows subtle. Green CTA.",
      motion: "Crisp, fast. Transitions <200ms. No decorative animations. Hover states instant.",
      brand: "ChatGPT green. Söhne typeface. OpenAI mark. Conversational UI. Accessible by default.",
      antiPatterns: "No purple. No gradients. No glow. No rounded-xl. No playful animations. No serif fonts.",
    }),
  },
];
